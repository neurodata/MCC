...
def dcorr2(X, Y):
    """Compute the two-sample Dcorr of X and Y"""
    return Dcorr.statistic(X, Y)


def compute_nbs(X, Y, test, THRESH, K=1000, TAIL="both"):
